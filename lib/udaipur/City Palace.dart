...
class CityPalaceU extends StatelessWidget{
  @override
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ClipRRect(
                          borderRadius: BorderRadius.circular(15),
                          child: Image.network('https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/City_Palace_of_Udaipur.jpg/1280px-City_Palace_of_Udaipur.jpg',fit: BoxFit.fill,)),
                    )
                  ],
                ),
              ),
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ClipRRect(
                          borderRadius: BorderRadius.circular(15),
                          child: Image.network('https://i0.wp.com/ricepotato.co/wp-content/uploads/2017/11/Udaipur-City-Palace-tips.jpg?fit=1000%2C581&ssl=1',fit: BoxFit.fill,)),
                    )
                  ],
                ),
              ),
